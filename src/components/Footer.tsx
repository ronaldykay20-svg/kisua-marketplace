      ...
      <div className="container mx-auto px-4 py-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-[13px]">
              ...
              <li>
                <a href="https://wa.me/244958348564" target="_blank" rel="noopener noreferrer" className="text-[#d9bfa5] hover:text-white">
                  WhatsApp
                </a>
              </li>
        ...
        <div className="border-t border-white/10 pt-6 mb-4">
          ...
          <div className="flex gap-3">
            <a href="https://www.facebook.com/profile.php?id=61580887037719" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors" aria-label="Facebook">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/>
              </svg>
            </a>
            <a href="https://www.instagram.com/ronaldo_nunes470" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors" aria-label="Instagram">
            ...
            <a href="https://wa.me/244958348564" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors" aria-label="WhatsApp">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                <path d={whatsappPath}/>
              </svg>
            </a>
