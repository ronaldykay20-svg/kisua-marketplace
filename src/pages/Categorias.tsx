...
/* ── Paleta ── */
const bg          = "#F5F0EA";   /* castanho quase branco, warm off-white */
const white       = "#FFFFFF";
const sand        = "#D4B896";
...
/* Imagens miniatura (thumbnail circular) — fallback da BD */
...
/* Banner/cover — imagem grande para o card */
  ...
  return (
    <div style={{ background: bg, minHeight: "100vh" }}>
      ...
      <div style={{
        ...
        <aside style={{
          ...
          <button
            ...
            style={{
              ...
              borderLeft: selectedCategory === null ? `3px solid ${sandDark}` : "3px solid transparent",
        ...
        {/* ── Conteúdo direito: grelha 3 colunas com fotos ── */}
              ...
              >
                ...
                <div style={{ width: "100%", aspectRatio: "1/0.68", position: "relative", overflow: "hidden" }}>
                  {cat.cover ? (
                    ...
                    <div style={{ width: "100%", height: "100%", background: brownLight, display: "flex", alignItems: "center", justifyContent: "center" }}>
                      <ShoppingBag style={{ width: 24, height: 24, color: sandDark }} />
                    </div>
                  )}

                  {/* Miniatura circular sobreposta no canto inferior esquerdo */}
                  {cat.image && (
                    <div style={{
      ...
      {/* Banner "Ofertas Imperdíveis" */}
      <div style={{ margin: "12px 10px 0", padding: "14px 16px", background: brown, borderRadius: 16, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <div style={{ width: 40, height: 40, borderRadius: 10, background: sandDark, display: "flex", alignItems: "center", justifyContent: "center" }}>
