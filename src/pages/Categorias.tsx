...
const Categorias = () => {
   ...
   * display_image_url já vem pronta do RPC: imagem própria da categoria,
   * ou — quando não existe — a do produto mais popular dessa categoria.
   */
  const categories: any[] = useMemo(() => {
    ...
    return dbCategories.map((c: any) => ({
      name:  c.name,
      id:    c.id,
      image: c.display_image_url || null,
      cover: c.display_image_url || null,
